...
def runTimings(mode : str):
    # CONFIGURATION
    SETTINGS_FILE = "../scenes/bigHuman1.json"
    ROOT_PATH = ".."
    RESOLUTION = (512, 512)
    NUM_FRAMES = 1
    ...
    TIMING_STEPS = 1
    OUTPUT_STATS_ALL = "../results/statistics/dvr-human/timingsConvergence-all-%s.tsv"
    OUTPUT_STATS_AVG = "../results/statistics/dvr-human/timingsConvergence-avg-%s.tsv"
    OUTPUT_HISTO_ALL = "../results/statistics/dvr-human/histogramsConvergence-%s.tsv"
    OUTPUT_HISTO_CFG = "../results/statistics/dvr-human/histogramConvergence-cfg-%s.tsv"
    OUTPUT_STATS_USE_DOUBLE = True
    os.makedirs("../results/statistics/dvr-human/", exist_ok=True)
