...
__forceinline__ __host__ __device__ double rmin(double a, double b)
{
    return fmin(a, b);
}

__forceinline__  __host__ __device__ double rmax(double a, double b)
{
    return fmax(a, b);
}

__forceinline__  __host__ __device__ float rmin(float a, float b)
{
    return fminf(a, b);
}

__forceinline__  __host__ __device__ float rmax(float a, float b)
{
    return fmaxf(a, b);
}

__forceinline__  __host__ __device__ float maxCoeff(float a)
{
    return a;
}
__forceinline__  __host__ __device__ float maxCoeff(float2 a)
{
    return fmaxf(a.x, a.y);
}
__forceinline__  __host__ __device__ float maxCoeff(float3 a)
{
    return fmaxf(a.x, fmaxf(a.y, a.z));
}
__forceinline__  __host__ __device__ float maxCoeff(float4 a)
{
    return fmaxf(a.x, fmaxf(a.y, fmaxf(a.z, a.w)));
}
__forceinline__  __host__ __device__ double maxCoeff(double a)
{
    return a;
}
__forceinline__  __host__ __device__ double maxCoeff(double2 a)
{
    return fmax(a.x, a.y);
}
__forceinline__  __host__ __device__ double maxCoeff(double3 a)
{
    return fmax(a.x, fmax(a.y, a.z));
}
__forceinline__  __host__ __device__ double maxCoeff(double4 a)
{
...
{
    return make_float4(fmaxf(a.x, b.x), fmaxf(a.y, b.y), fmaxf(a.z, b.z), fmax(a.w, b.w));
}
...
{
    return make_double2(ceilf(v.x), ceilf(v.y));
}
inline __host__ __device__ double3 ceil(double3 v)
{
    return make_double3(ceilf(v.x), ceilf(v.y), ceilf(v.z));
}
inline __host__ __device__ double4 ceil(double4 v)
{
    return make_double4(ceilf(v.x), ceilf(v.y), ceilf(v.z), ceilf(v.w));
}
...
{
    return make_double2(fabsf(v.x), fabsf(v.y));
}
inline __host__ __device__ double3 fabs(double3 v)
{
    return make_double3(fabsf(v.x), fabsf(v.y), fabsf(v.z));
}
inline __host__ __device__ double4 fabs(double4 v)
{
    return make_double4(fabsf(v.x), fabsf(v.y), fabsf(v.z), fabsf(v.w));
}
...
inline __host__ __device__ float fsignf(float v)
{
	return copysignf(1.0f, v);
}
inline __host__ __device__ float2 fsignf(float2 v)
{
	return make_float2(fsignf(v.x), fsignf(v.y));
}
inline __host__ __device__ float3 fsignf(float3 v)
{
	return make_float3(fsignf(v.x), fsignf(v.y), fsignf(v.z));
}
inline __host__ __device__ float4 fsignf(float4 v)
{
	return make_float4(fsignf(v.x), fsignf(v.y), fsignf(v.z), fsignf(v.w));
}
...
inline __host__ __device__ double2 fsign(double2 v)
{
	return make_double2(fsign(v.x), fsign(v.y));
}
inline __host__ __device__ double3 fsign(double3 v)
{
	return make_double3(fsign(v.x), fsign(v.y), fsign(v.z));
}
inline __host__ __device__ double4 fsign(double4 v)
{
	return make_double4(fsign(v.x), fsign(v.y), fsign(v.z), fsign(v.w));
}

inline __host__ __device__ int isign(float v)
{
	return v >= 0 ? 1 : -1; //copysignf(1.0f, v);
}
inline __host__ __device__ int2 isign(float2 v)
{
	return make_int2(isign(v.x), isign(v.y));
}
inline __host__ __device__ int3 isign(float3 v)
{
	return make_int3(isign(v.x), isign(v.y), isign(v.z));
}
inline __host__ __device__ int4 isign(float4 v)
{
	return make_int4(isign(v.x), isign(v.y), isign(v.z), isign(v.w));
}
